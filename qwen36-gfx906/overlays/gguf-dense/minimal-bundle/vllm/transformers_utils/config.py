...
def maybe_override_with_speculators(
    ...
    **kwargs,
    ...
    if check_gguf_file(model):
        # Local GGUF files can carry GGUF architecture strings that the
        # Transformers GGUF config reader does not understand yet. Speculator
        # detection is not needed for these local GGUF benchmark artifacts;
        # let the normal ModelConfig path use the explicit hf_config_path.
