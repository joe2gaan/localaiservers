# GitHub Project Update Template

## Title

LocalAIServers public documentation update: [short topic]
...
- Repo file or pull request: [link]
- Runtime image, digest, command, or benchmark evidence: [link or text]
