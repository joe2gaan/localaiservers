...
```text
Donations support open-source maintenance, documentation, QC methodology, benchmark reporting, and community AI research access. Program payments are separate from charitable donations.
```
